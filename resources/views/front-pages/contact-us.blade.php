...
@section('content')
    ...
    <!--    </div>-->
    <!--</section>-->
    <section class="magic-contact-section">

    <div class="container">

        <!-- HEADING -->
        <div class="magic-contact-heading">
            <h2>Let's Create <span>Your Magic</span> Together</h2>

            <p>
                Drop us a message and our team will contact you within minutes
                to plan your unforgettable celebration.
            </p>
        </div>
        ...
        <div class="row g-4 align-items-stretch">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="magic-input-group">
                                    <label class="magic-input-label">Your Name</label>
                            ...
                            <div class="col-md-6">
                                <div class="magic-input-group">
                                    <label class="magic-input-label">Mobile Number</label>
                            ...
                            <div class="col-md-6">
                                <div class="magic-input-group">
                                    <label class="magic-input-label">Event Type</label>

                                    <select name="service_id" class="magic-select" required>
                            ...
                            <div class="col-12">
                                <button type="submit" class="magic-submit-btn">
            ...
            <div class="col-lg-5">
                ...
                <div class="magic-contact-card">
                    ...
                    <h3 class="magic-contact-title">
                        Get in Touch
                    </h3>


                    <div class="magic-contact-item">

                        <div class="magic-contact-icon">
